...
.env example:
    ...
    LOGPOINT_ID=EXAMPLE_LOGPOINT_ID_000000000000000000000000000000
...
def _follow_monitor_order(
    ...
    while True:
        ...
        try:
            ...
            d = [key for key, value in dict(resp.json()).get("response",{}).items()]
            LOG.debug(f"monitorapi resp: {d}")
